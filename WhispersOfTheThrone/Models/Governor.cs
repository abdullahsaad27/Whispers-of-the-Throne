...
namespace WhispersOfTheThrone.Models
{
    ...
    {
        public TitleRank Rank { get; set; } = TitleRank.Duke; // Default existing governors to Duke level
        public string LiegeId { get; set; } = ""; // Empty string implies independent or direct vassal to player
        public List<string> VassalIds { get; set; } = new List<string>(); // List of IDs of sub-vassals
